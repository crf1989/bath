...
const double TIME_INTERVAL = 1e-2;
const double S = 3.968626966596886;
const double J1 = 0;  	/* eV */
const double JH = 0;		/* eV */
const double B = 0;		/* magnetic field, T */

const double LEFT_LEAD_TEMPERATURE = 500; /* Kelvin */
const double LEFT_UP_LEAD_CHEMICAL_POTENTIAL = -1.9; /* eV */
const double LEFT_DOWN_LEAD_CHEMICAL_POTENTIAL = -1.8; /* eV */

const double RIGHT_LEAD_TEMPERATURE = 500; /* kelvin */
